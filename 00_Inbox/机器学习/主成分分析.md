...
假设 $x=(x_1,x_2,\cdots,x_m)^T$ 是 $m$ 维 [[00-笔记/概率论与数理统计/一维随机变量及其分布|随机变量]]，其均值向量为 $\vec\mu$，于是有
$$
...
主成分分析得到的结果可以用于其他机器学习方法的输入，比如，将样本点投影到以主成分为坐标轴的空间中，然后应用[[00-笔记/机器学习/聚类|聚类]]算法，就可以对样本点进行聚类。
