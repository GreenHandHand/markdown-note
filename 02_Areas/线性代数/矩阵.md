...
> 1. $|A|\neq 0$
> 2. $r(A)=n$
> 3. $A$ 的列 (或者行)[[02_Areas/线性代数/向量组|向量组]] 线性无关
> 4. [[02_Areas/线性代数/线性方程组#齐次线性方程组|齐次线性方程组]] $Ax=0$ 只有零解
> 5. [[02_Areas/线性代数/线性方程组#非齐次线性方程组|非齐次线性方程组]] $Ax=b$ 有唯一解
> 6. $A$ 的 [[02_Areas/线性代数/特征值与特征向量|特征值]] 均不为零
...
< [[02_Areas/线性代数/行列式|行列式]] | [[02_Areas/线性代数/向量组|向量组]] >
