...
[[软件工程/面向对象方法学|面向对象程序设计]] (*Object-Oriented Porgramming, OOP*) 是一种范式，其基本理念是将数据块及与数据相关的行为封装成为特殊的、名为**对象**的实体。同时，对象实体的生成工作则是基于程序员给出的一系列蓝图，这些蓝图就是**类**。

### 对象与类

我们常使用 UML 来表述一个类。

![[image/面向对象基础.png|UML类图|500]]
...
![[image/面向对象基础-1.png|类层次结构的 UML 图|500]]
