...
🌄**早** 起床 `INPUT[time(showcase,class(time-input-box)):getup]`
- [ ] (9:00~10:30) 英语-单词一 📅 <% tp.date.now("YYYY-MM-DD") %>
- [ ] (10:30~11:00) 高数-习题 📅 <% tp.date.now("YYYY-MM-DD") %>
---
☀️**午** 饭点 `INPUT[time(showcase,class(time-input-box)):lunch]`
- [ ] (13:00~15:00) 高数-习题 📅 <% tp.date.now("YYYY-MM-DD") %>
---
🌇**晚** 晚饭 `INPUT[time(showcase,class(time-input-box)):dinner]`
...
---
💤 `INPUT[time(showcase,class(time-input-box)):sleep]`
