...
> \end{gather}
> $$
> 向量组 $\alpha_{1},\alpha_{2},\dots,\alpha_{m}$ 线性相关 $\iff$ [[00-笔记/线性代数/线性方程组#齐次线性方程组|齐次线性方程组]]
>  $$
...
> [!note]
> 由 [[00-笔记/线性代数/线性方程组|线性方程组]] 我们可以得到，如果一个向量组中，向量的个数大于向量的维数，则线性方程组必有非零解，因此，任意 $n+1$ 个 $n$ 维向量都是线性相关的。
>
...
$$
4. 若将向量组构成一个 $m\times n$ 的矩阵，则满足 [[00-笔记/线性代数/矩阵#有关秩的重要式子|矩阵的秩]] 的性质。
...
该部分简单介绍向量空间的内容。更多的参见 [[00-笔记/矩阵分析/线性空间|线性空间]]。
...
< [[00-笔记/线性代数/矩阵|矩阵]] | [[00-笔记/线性代数/线性方程组|线性方程组]] >
